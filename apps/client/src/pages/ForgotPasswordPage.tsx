  ...
  return (
    <div style={{
      ...
      <motion.div 
        ...
        style={{
          width: '50%', height: 'calc(100vh - 32px)', position: 'sticky', top: '16px', borderRadius: '40px', overflow: 'hidden',
          display: 'flex', flexDirection: 'column', alignItems: 'center', boxShadow: '0 20px 40px rgba(0,0,0,0.1)'
        }}
